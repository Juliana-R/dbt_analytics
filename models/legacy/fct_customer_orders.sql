with paid_orders as (select orders.id as order_id,
    ...
    from dev.jaffle_shop.orders as orders
...
left join dev.jaffle_shop.customers c on orders.user_id = c.id ),
...
customer_orders 
    ...
    from dev.jaffle_shop.customers c 
    left join dev.jaffle_shop.orders as orders
